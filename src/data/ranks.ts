...
export const RANK_TIERS: RankTier[] = [
  ...
  { name: 'Unearthly', rankNumber: 88, abbreviation: 'UN', source: 'standard' },
  { name: 'Shift X', rankNumber: 126, abbreviation: 'SX', source: 'standard' },
  { name: 'Shift Y', rankNumber: 176, abbreviation: 'SY', source: 'standard' },
  { name: 'Shift Z', rankNumber: 351, abbreviation: 'SZ', source: 'standard' },
